...
default:throw this.db.handleError(h);}};a.prototype.Bb=function(h){null==h&&(h=this.Ra,this.Ra+=1);return tc(this.Ta,h)};a.prototype.Jb=function(h){null==h&&(h=this.Ra,this.Ra+=1);h=qb(this.Ta,h);if("function"!==typeof BigInt)throw Error("BigInt is not supported");return BigInt(h)};a.prototype.Kb=function(h){null==h&&(h=this.Ra,this.Ra+=1);return qb(this.Ta,h)};a.prototype.getBlob=function(h){null==h&&(h=this.Ra,this.Ra+=1);var l=vc(this.Ta,h);h=uc(this.Ta,h);for(var q=new Uint8Array(l),r=0;r<l;r+=
1)q[r]=x[h+r];return q};a.prototype.get=function(h,l){l=l||{};null!=h&&this.bind(h)&&this.step();h=[];for(var q=sc(this.Ta),r=0;r<q;r+=1)switch(wc(this.Ta,r)){case 1:var B=l.useBigInt?this.Jb(r):this.Bb(r);h.push(B);break;case 2:h.push(this.Bb(r));break;case 3:h.push(this.Kb(r));break;case 4:h.push(this.getBlob(r));break;default:h.push(null)}return h};a.prototype.getColumnNames=function(){for(var h=[],l=rc(this.Ta),q=0;q<l;q+=1)h.push(xc(this.Ta,q));return h};a.prototype.getAsObject=function(h,l){h=
this.get(h,l);l=this.getColumnNames();for(var q={},r=0;r<l.length;r+=1)q[l[r]]=h[r];return q};a.prototype.getSQL=function(){return C(this.Ta)};a.prototype.getNormalizedSQL=function(){return I(this.Ta)};a.prototype.run=function(h){null!=h&&this.bind(h);this.step();return this.reset()};a.prototype.wb=function(h,l){null==l&&(l=this.Ra,this.Ra+=1);h=fa(h);var q=ha(h);this.nb.push(q);this.db.handleError(lc(this.Ta,l,q,h.length-1,0))};a.prototype.Eb=function(h,l){null==l&&(l=this.Ra,this.Ra+=1);var q=ha(h);
...
h){this.Hb(l);return}if(null!=h.length){this.Eb(h,l);return}}throw"Wrong API use : tried to bind a value of an unknown type ("+h+").";};a.prototype.Gb=function(h){var l=this;Object.keys(h).forEach(function(q){var r=oc(l.Ta,q);0!==r&&l.xb(h[q],r)});return!0};a.prototype.Fb=function(h){for(var l=0;l<h.length;l+=1)this.xb(h[l],l+1);return!0};a.prototype.reset=function(){this.freemem();return 0===zc(this.Ta)&&0===yc(this.Ta)};a.prototype.freemem=function(){for(var h;void 0!==(h=this.nb.pop());)ia(h)};
a.prototype.free=function(){this.freemem();var h=0===Ac(this.Ta);delete this.db.hb[this.Ta];this.Ta=0;return h};b.prototype.next=function(){if(null===this.gb)return{done:!0};null!==this.bb&&(this.bb.free(),this.bb=null);if(!this.db.db)throw this.pb(),Error("Database closed");var h=ka(),l=v(4);la(d);la(l);try{this.db.handleError(aa(this.db.db,this.lb,-1,d,l));this.lb=t(l,"i32");var q=t(d,"i32");if(0===q)return this.pb(),{done:!0};this.bb=new a(q,this.db);this.db.hb[q]=this.bb;return{value:this.bb,
done:!1}}catch(r){throw this.rb=y(this.lb),this.pb(),r;}finally{ma(h)}};b.prototype.pb=function(){ia(this.gb);this.gb=null};b.prototype.getRemainingSQL=function(){return null!==this.rb?this.rb:y(this.lb)};"function"===typeof Symbol&&"symbol"===typeof Symbol.iterator&&(b.prototype[Symbol.iterator]=function(){return this});c.prototype.createCSVTable=function(h,l){if(!this.db)throw"Database closed";if(null==h)throw"No data for CSV file";let q="csvfile_"+(4294967295*Math.random()>>>0);null!=h&&ea(q,h);
...
l+'";',0,0,d))};c.prototype.createVSVTable=function(h,l,q){if(!this.db)throw"Database closed";if(null==h)throw"No data for VSV file";let r="vsvfile_"+(4294967295*Math.random()>>>0);null!=h&&ea(r,h);postMessage({progress:"Loading VSV File"});this.handleError(p(this.db,'CREATE VIRTUAL TABLE temp."'+l+"\" USING vsv(filename='"+r+"', fsep='\\x"+q+"', header=true, affinity=integer);",0,0,d));h="Table"+l.replace(/ /g,"").replace(".","");postMessage({progress:"Converting file "+l+" to table '"+h+"'. This may take a couple of minutes for files over 100MB in size."});
this.handleError(p(this.db,"CREATE TABLE "+h+' AS\n SELECT * FROM temp."'+l+'";',0,0,d));postMessage({progress:"Cleaning up"});this.handleError(p(this.db,'DROP TABLE temp."'+l+'";',0,0,d))};c.prototype.run=function(h,l){if(!this.db)throw"Database closed";if(l){h=this.prepare(h,l);try{h.step()}finally{h.free()}}else this.handleError(p(this.db,h,0,0,d));return this};c.prototype.exec=function(h,l,q){if(!this.db)throw"Database closed";var r=ka(),B=null;try{var U=ca(h)+1,G=v(U);k(h,x,G,U);var ja=G;var ba=
v(4);for(h=[];0!==t(ja,"i8");){la(d);la(ba);this.handleError(aa(this.db,ja,-1,d,ba));var D=t(d,"i32");ja=t(ba,"i32");if(0!==D){U=null;B=new a(D,this);for(null!=l&&B.bind(l);B.step();)null===U&&(U={columns:B.getColumnNames(),values:[]},h.push(U)),U.values.push(B.get(null,q));B.free()}}return h}catch(N){throw B&&B.free(),N;}finally{ma(r)}};c.prototype.each=function(h,l,q,r,B){"function"===typeof l&&(r=q,q=l,l=void 0);h=this.prepare(h,l);try{for(;h.step();)q(h.getAsObject(null,B))}finally{h.free()}if("function"===
typeof r)return r()};c.prototype.prepare=function(h,l){la(d);this.handleError(u(this.db,h,-1,d,0));h=t(d,"i32");if(0===h)throw"Nothing to prepare";var q=new a(h,this);null!=l&&q.bind(l);return this.hb[h]=q};c.prototype.iterateStatements=function(h){return new b(h,this)};c.prototype["export"]=function(){Object.values(this.hb).forEach(function(l){l.free()});Object.values(this.Za).forEach(na);this.Za={};this.handleError(m(this.db));var h=oa(this.filename);this.handleError(g(this.filename,d));this.db=
t(d,"i32");return h};c.prototype.close=function(){null!==this.db&&(Object.values(this.hb).forEach(function(h){h.free()}),Object.values(this.Za).forEach(na),this.Za={},this.handleError(m(this.db)),pa("/"+this.filename),this.db=null)};c.prototype.handleError=function(h){if(0===h)return null;h=qc(this.db);throw Error(h);};c.prototype.getRowsModified=function(){return w(this.db)};c.prototype.create_function=function(h,l){Object.prototype.hasOwnProperty.call(this.Za,h)&&(na(this.Za[h]),delete this.Za[h]);
var q=qa(function(r,B,U){for(var G,ja=[],ba=0;ba<B;ba+=1){var D=t(U+4*ba,"i32"),N=Cc(D);if(1===N||2===N)D=Gc(D);else if(3===N)D=Ec(D);else if(4===N){N=D;D=Dc(N);N=Fc(N);for(var vb=new Uint8Array(D),Aa=0;Aa<D;Aa+=1)vb[Aa]=x[N+Aa];D=vb}else D=null;ja.push(D)}try{G=l.apply(null,ja)}catch(Nc){sb(r,Nc,-1);return}switch(typeof G){case "boolean":Kc(r,G?1:0);break;case "number":Hc(r,G);break;case "string":Ic(r,G,-1,-1);break;case "object":null===G?rb(r):null!=G.length?(B=ha(G),Jc(r,B,G.length,-1),ia(B)):
sb(r,"Wrong API use : tried to return a value of an unknown type ("+G+").",-1);break;default:rb(r)}});this.Za[h]=q;this.handleError(Bc(this.db,h,l.length,1,0,q,0,0,0));return this};e.Database=c};var ra={},z;for(z in e)e.hasOwnProperty(z)&&(ra[z]=e[z]);var sa="./this.program",ta="object"===typeof window,ua="function"===typeof importScripts,va="object"===typeof process&&"object"===typeof process.versions&&"string"===typeof process.versions.node,A="",wa,xa,ya,za,Ba;
